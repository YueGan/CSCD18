...
// //  loadTexture(o,"./bubble.ppm",1,&texture_list);
//  insertObject(o, &object_list);

  o=newSphere(.05,.95,.95,.75,.75,.95,.55,0,1,6);
 Scale(o,1.2,1.2,.2);
//  RotateZ(o,-PI/1.5);
 Translate(o,1.8,9.3,4.35);
 invert(&o->T[0][0],&o->Tinv[0][0]);
 loadTexture(o,"./bubble.ppm",1,&texture_list);
 insertObject(o, &object_list);
...
//  RotateZ(o,-PI/1.5);
 ...
 Translate(o, 0, -4, 4);
 invert(&o->T[0][0], &o->Tinv[0][0]);
 loadTexture(o, "./sand.ppm", 1, &texture_list);
 insertObject(o, &object_list);
...
//  Translate(o, 0, 10, 12);
//  invert(&o->T[0][0], &o->Tinv[0][0]);
//  loadTexture(o, "./spongebob.ppm", 1, &texture_list);
//  insertObject(o, &object_list);
...
/* Area light source */
 ...
 o=newPlane(1,1,1,0,0.95,0.95,0.95,1,1,1);
 Scale(o, 1.5, 1.5, 1.5);
 RotateX(o, -PI/4);
 Translate(o, 0, 7, 1);
 invert(&o->T[0][0], &o->Tinv[0][0]);
 ...
 for (int i = 0; i < 5; i ++){
  ...
  p.pz = z;
  p.pw = 1;
  l = newPLS(&p, 0.95/5, 0.95/5, 0.95/5);
 ...
 //  Translate(o,0,-4,5);
 //  invert(&o->T[0][0],&o->Tinv[0][0]);
 //  loadTexture(o,"./floor.ppm",1,&texture_list);
 //  insertObject(o,&object_list);
